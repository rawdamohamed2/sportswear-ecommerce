...
const FeaturedProducts = ({products}:{products:Product[]}) => {
    ...
    <Carousel className={`overflow-hidden`}>
        ...
        <CarouselPrevious className={`bg-primary text-font hover:bg-transparent hover:shadow-md hover:shadow-primary/50 hover:text-darkgray z-50`}/>
        <CarouselNext className={` bg-primary text-font hover:bg-transparent hover:shadow-md hover:shadow-primary/50 hover:text-darkgray z-50`}/>
    </Carousel>
    )
}
